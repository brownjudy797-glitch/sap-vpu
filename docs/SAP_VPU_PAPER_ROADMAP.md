...
| Paper workload | TinyViT MLP smoke now repeats each policy tile 16 times and exports policy/ablation counters; current numbers remain smoke-only evidence. | `make tinyvit-summary`, `docs/SAP_VPU_TINYVIT_SMOKE_RECORD.md` |
