...
| Paper workload | TinyViT MLP smoke now repeats each policy tile 16 times and exports INT8/INT4/INT2 policy and ablation counters; current numbers remain smoke-only evidence. | `make tinyvit-summary`, `docs/SAP_VPU_TINYVIT_SMOKE_RECORD.md` |
